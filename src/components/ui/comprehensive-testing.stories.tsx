...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Comprehensive testing of all UI components with accessibility validation.",
      },
    },
    a11y: {
      config: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Button variant="secondary" aria-label="Secondary style button">
                Secondary
              </Button>
              <Button
                variant="destructive"
                aria-label="Destructive action button"
              >
                Destructive
              </Button>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <Button variant="outline" aria-label="Outlined button">
                Outline
              </Button>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Button size="default" aria-label="Default size button">
                Default
              </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Badge variant="default" aria-label="Default status badge">
                Default
              </Badge>
              <Badge variant="secondary" aria-label="Secondary status badge">
                Secondary
              </Badge>
              <Badge variant="destructive" aria-label="Error status badge">
                Error
              </Badge>
              <Badge variant="outline" aria-label="Outlined badge">
                Outline
              </Badge>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Badge variant="default" aria-label="Active status">
                  Ativo
                </Badge>
              ...
              <div className="flex items-center gap-2">
                <Badge variant="secondary" aria-label="Premium plan">
                  Premium
                </Badge>
                <span className="text-sm text-muted-foreground">
                  Tipo de plano
              ...
              <div className="flex items-center gap-2">
                <Badge variant="destructive" aria-label="Expired status">
                  Expirado
                </Badge>
                <span className="text-sm text-muted-foreground">
          ...
          >
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <Badge variant="default" aria-label="Plano mais popular">
                  Popular
                </Badge>
              </div>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <p className="text-2xl font-bold">
                  R$ 49<span className="text-sm font-normal">/mês</span>
                </p>
                <ul className="text-sm space-y-1">
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  aria-label="Assinar plano profissional"
                >
                  Começar Agora
                </Button>
              </div>
        ...
        <div className="flex flex-wrap gap-4">
          <Dialog>
            <DialogTrigger asChild>
              <Button aria-label="Abrir modal de informações">
                Informações
              </Button>
            </DialogTrigger>
            <DialogContent
            ...
            >
              ...
              <div className="space-y-4">
                <p>
                  Esta é uma demonstração do componente Dialog com foco na
                  acessibilidade.
                </p>
                <ul className="text-sm space-y-1">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button
                variant="destructive"
                aria-label="Abrir confirmação de exclusão"
              >
                Excluir Conta
              </Button>
            </DialogTrigger>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <p className="text-red-700 text-sm mt-1">
                    Esta ação irá excluir permanentemente sua conta e todos os
                    dados associados.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 bg-destructive text-destructive-foreground rounded-lg">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="mt-2 border-white text-white hover:bg-white hover:text-destructive"
                >
                  Teste
                </Button>
              </div>
