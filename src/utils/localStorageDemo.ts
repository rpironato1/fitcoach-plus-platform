...
const fitcoachLocalStorageDemo = {
  ...
  getStatus: () => {
    ...
    console.log('  - Current session:', session ? `${session.user.email} (${session.user.id})` : 'None');
...
if (process.env.NODE_ENV === 'development') {
  console.log('🚀 FitCoach LocalStorage Demo loaded! Run fitcoachLocalStorageDemo.help() for all commands.');
  console.log('💡 Quick start: fitcoachLocalStorageDemo.enableLocalStorage() then fitcoachLocalStorageDemo.loginAsTrainer()');
}
