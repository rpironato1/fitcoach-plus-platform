...
export default function StudentDashboardDemo() {
  ...
  // Save student profile data (simulated)
  ...
  const handleGenderChange = (gender: string) => {
    saveStudentProfile({ gender });
  };

  const handleMenstrualCycleToggle = (enabled: boolean) => {
    saveStudentProfile({ menstrualCycleTracking: enabled });
  };
