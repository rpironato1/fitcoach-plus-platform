// Components
export {
  LocalStorageAuthProvider as AuthProvider,
  useLocalStorageAuth as useAuth,
...
} from "./services/LocalStorageAuthService";
...
export async function setupAuthModule() {
  ...
  const { LocalStorageAuthService, LocalStorageProfileService } = await import(
    "./services/LocalStorageAuthService"
  );
