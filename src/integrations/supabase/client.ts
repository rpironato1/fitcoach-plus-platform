...
console.warn('⚠️  Supabase client is disabled. Application is running in localStorage-only mode.');
...
export function getSupabaseClient() {
  throw new Error('Supabase is disabled. This application now runs entirely on localStorage.');
}