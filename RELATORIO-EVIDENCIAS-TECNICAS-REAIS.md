...
className =
  "hover:text-white focus:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900";
```
...
_Este relatório contém apenas dados verificados tecnicamente e deve substituir informações contraditórias dos relatórios anteriores._
